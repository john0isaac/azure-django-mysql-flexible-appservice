...
- azure-app-service
- azure-mysql
urlFragment: azure-django-mysql-flexible-appservice
name: Deploy Django Application with MySQL on Azure App Service (Python)
...
# Deploy Django Application with MySQL via Azure App Service
